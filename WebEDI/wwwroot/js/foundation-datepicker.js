        ...
        fill: function() {
            ...
            if (this.language === "ja") {
                ...
                this.picker.find('.datepicker-hours thead th:eq(1)')
                    .text(dayMonth + ' ' + year + ' ' + dates[this.language].months[month]);
                this.picker.find('.datepicker-minutes thead th:eq(1)')
                    .text(dayMonth + ' ' + year + ' ' + dates[this.language].months[month]);
                this.picker.find('tfoot th.today')
                    .text(dates[this.language].today + ": " + year + dates[this.language].year[0] + dates[this.language].months[month] + dayMonth + dates[this.language].day[0]);
            } else {
                this.picker.find('.datepicker-days thead th:eq(1)')
